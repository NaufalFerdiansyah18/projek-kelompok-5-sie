...
<body>
    ...
    <div class="container">
        <div class="section-title">
            ...
            <h1 class="display-4">Resep Nikmat Sejak [Tahun Berdiri Anda]</h1>
        </div>
        <div class="row">
            <div class="col-lg-4 py-0 py-lg-5">
                ...
                <a href="" class="btn btn-primary font-weight-bold py-2 px-4 mt-2">Pesan Sekarang</a>
            </div>
            <div class="col-lg-4 py-5 py-lg-0" style="min-height: 500px;">
                <div class="position-relative h-100">
                    <img class="position-absolute w-100 h-100" src="{{ asset('assets/img/foto-risoles-umkm.jpg') }}" style="object-fit: cover;">
                </div>
            </div>
            <div class="col-lg-4 py-0 py-lg-5">
                ...
                <h5 class="mb-3"><i class="fa fa-check text-primary mr-3"></i>Inovasi Varian Rasa (Contoh: Risoles Mayo, Ragout, Smoked Beef)</h5>

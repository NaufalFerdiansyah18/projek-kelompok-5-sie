    ...
    <div>
        ...
        <div class="brand-logo">
            <a href="{{ route('admin.dashboard') }}" class="d-none d-md-flex align-items-center gap-2 text-decoration-none">
                <img src="{{ asset('assets-koppe/images/brand/logo/logo-icon.svg') }}" alt="koppee" height="32">
                <span class="fw-bold fs-4 site-logo-text">koppee</span>
            </a>
        </div>
        ...
        <ul class="navbar-nav flex-column">
            ...
            <li class="nav-item">
                <div class="text-center py-5 upgrade-ui">
                    <div>
                        <img src="{{ asset('assets-koppe/images/avatar/avatar-1.jpg') }}" alt="User" class="avatar avatar-md rounded-circle mb-3">
                        <div class="my-3">
                            <h5 class="mb-1 fs-6">Admin User</h5>
                            <span class="text-secondary">koppee UI - Free Version</span>
                        </div>
